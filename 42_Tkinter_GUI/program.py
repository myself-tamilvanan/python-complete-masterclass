...
class Calculator:
    ...
    def _build_ui(self):
        # Display
        self.display = tk.Entry(self.root, font=("Arial", 24), bd=10,
        ...
        for text, row, col in buttons:
            ...
            btn = tk.Button(self.root, text=text, font=("Arial", 16),
                           command=cmd, bg="#f0f0f0", relief=tk.RAISED)
...
class RegistrationForm:
    ...
    def __init__(self, root):
        ...
        # Gender selection
        tk.Label(root, text="Gender:", font=("Arial", 12)).grid(row=4, column=0, padx=10, sticky="e")
        self.gender = ttk.Combobox(root, values=["Male", "Female", "Other"], width=22)
        self.gender.grid(row=4, column=1, padx=10, pady=10)
        
        # Submit button
        tk.Button(root, text="Register", command=self._submit,
                  bg="green", fg="white", font=("Arial", 12)).grid(row=5, column=1, pady=10)
